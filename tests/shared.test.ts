...
describe('statForTitle', () => {
  ...
  it('returns agility for jumping jack titles', () => { expect(statForTitle('Jumping Jacks [0/30]')).toBe('agility'); });
  it('returns agility for legacy stretch titles', () => { expect(statForTitle('Stretch [0/60]')).toBe('agility'); });
